...
sqrt(0 + 36 + 0) = 6 — so the shape-aware statement "B is closer to A
than C is" is one subtraction per coordinate. *What it buys you:*
...
many were real?") is 18/21 ≈ 86%. Every detection metric in this repo is
